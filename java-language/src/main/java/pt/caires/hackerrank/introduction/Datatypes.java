...
public class Datatypes
{
    ...
    {
        final boolean isByte = checkNumberType(num, Byte.TYPE.getTypeName().toLowerCase(), Byte.MIN_VALUE, Byte.MAX_VALUE);
        final boolean isShort = checkNumberType(num, Short.TYPE.getTypeName().toLowerCase(), Short.MIN_VALUE, Short.MAX_VALUE);
        final boolean isInt = checkNumberType(num, Integer.TYPE.getTypeName().toLowerCase(), Integer.MIN_VALUE, Integer.MAX_VALUE);
        final boolean isLong = checkNumberType(num, Long.TYPE.getTypeName().toLowerCase(), Long.MIN_VALUE, Long.MAX_VALUE);
