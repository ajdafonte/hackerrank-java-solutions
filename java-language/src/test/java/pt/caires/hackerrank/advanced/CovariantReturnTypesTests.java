...
public class CovariantReturnTypesTests
{
    public static void main(final String[] args)
    {
        ...
        if (failures > 0)
        {
            throw new RuntimeException("Incurred " + failures + " failures while testing " + CovariantReturnTypes.class.getSimpleName());
        }
        else
        {
    ...
    private static int checkResult(final String input, final String expectedResult)
    {
        ...
        {
            System.err.println("Expected a Flower with name '" + expectedResult + "' , got a Flower with name '" + input + "' ");
            return 1;
        }
